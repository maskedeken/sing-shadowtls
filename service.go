...
func (s *Service) NewConnection(ctx context.Context, conn net.Conn, metadata M.Metadata) error {
	...
	case 3:
		...
		return s.handler.NewConnection(ctx, bufio.NewCachedConn(deadline.NewConn(newVerifiedConn(conn, hmacAdd, hmacVerify, nil, !supportTLS13)), clientFirstFrame), metadata)
	}
}
